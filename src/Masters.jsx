...
const MASTER_IMPORT_CONFIG = {
  ...
  products_master: {
    ...
    fields: [
      ...
      { key: 'manufacturer',      label: 'Manufacturer',      required: false, aliases: ['manufacturer', 'mfr', 'brand', 'maker'] },
      { key: 'material_type',     label: 'Material Type',     required: false, aliases: ['material type', 'material', 'type', 'category'] },
      { key: 'pack_size',         label: 'Pack Size',         required: false, aliases: ['pack size', 'pack', 'packaging', 'size'] },
      { key: 'pack_dimension',    label: 'Pack Dimension',    required: false, aliases: ['pack dimension', 'dimension', 'dimensions'] },
      { key: 'pack_weight',       label: 'Pack Weight',       required: false, aliases: ['pack weight', 'weight', 'gross weight'] },
      { key: 'unit_of_measurement', label: 'UOM',             required: false, aliases: ['unit of measurement', 'uom', 'unit', 'units'] },
      ...
      { key: 'hsn_code',          label: 'HSN Code',          required: false, aliases: ['hsn code', 'hsn', 'harmonized code', 'hs code', 'tariff code'] },
      { key: 'remarks',           label: 'Remarks',           required: false, aliases: ['remarks', 'notes'] },
    ],
  },
  storage_master: {
